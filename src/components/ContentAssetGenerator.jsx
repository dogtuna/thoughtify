...
const ContentAssetGenerator = () => {
  ...
  const functionUrl = `https://us-central1-${projectId}.cloudfunctions.net/generateContentAssets`;
  ...
  }, [learningDesignDocument, initiativeId, functionUrl, setDraftContent, setMediaAssets]);
